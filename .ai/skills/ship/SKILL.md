...
4. **Docs** — README / install / usage reflect actual state; quickstart works from the clean clone; corpus is deduplicated, terse, navigable → `docs-review` (currency rules via `software-engineering` §Documentation).
