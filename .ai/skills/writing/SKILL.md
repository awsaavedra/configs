...
when_to_use: Drafting or editing anything meant for readers — blog posts, essays, personal writing, stories, poems, reviews. Name the type and edit depth first; apply only the sections and passes that bind. Adversarial read → argumentation §Steelyman (writing lens) · clarity audit → diagnostic §Feynman-Test · sourcing → research · publish-readiness → writing-ship. Not for code docs currency — that's software-engineering §Documentation.
---
